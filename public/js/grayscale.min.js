function init() {
    var e = {
            zoom: 15,
            center: new google.maps.LatLng(6.585885, 3.397368),
            disableDefaultUI: !0,
            scrollwheel: !1,
            draggable: !1,
            styles: [{
    ...
    var l = new google.maps.LatLng(6.585885, 3.397368);
    new google.maps.Marker({
        position: l,
        map: map,
        icon: "../map-markerr.svg"
    })
}! function(e) {
    "use strict";
...
google.maps.event.addDomListener(window, "load", init), google.maps.event.addDomListener(window, "resize", function() {
    map.setCenter(new google.maps.LatLng(6.585885, 3.397368))
});